...
const documentSchema = new mongoose.Schema(
  {
    ...
    finalizationStatus: { type: String, enum: ['draft', 'ready_for_review', 'confirmed', 'pdf_generated'], default: 'draft' },
    generatedPdfPath: { type: String, default: undefined, select: false },
    generatedPdfCreatedAt: { type: Date, default: undefined },
